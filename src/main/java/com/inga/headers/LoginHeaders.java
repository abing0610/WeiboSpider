...
public class LoginHeaders {
    ...
    private static final Logger logger = Logger.getLogger(LoginHeaders.class);
    ...
    public static Map<String , String> packageHeaders(){
        ...
        map.put(HeaderConstant.Cache_Control, "no-cache");
        map.put(HeaderConstant.Connection, "keep-alive");
        map.put(HeaderConstant.Host, "login.sina.com.cn");
        map.put(HeaderConstant.Origin, "http://login.sina.com.cn");
        map.put(HeaderConstant.Pragma, "no-cache");
    ...
    public static List<BasicNameValuePair> packageNVPS(Map<String , Object> map){
        ...
        nvps.add(new BasicNameValuePair("nonce" ,String.valueOf(map.get("nonce")) ));
        nvps.add(new BasicNameValuePair("pagerefer" , "http://login.sina.com.cn/sso/logout.php"));
        nvps.add(new BasicNameValuePair("prelt" , "67"));
        nvps.add(new BasicNameValuePair("pwencode", "rsa2"));
        nvps.add(new BasicNameValuePair("returntype", "TEXT"));
        nvps.add(new BasicNameValuePair("rsakv", String.valueOf(map.get("rsakv"))));
        nvps.add(new BasicNameValuePair("savestate", "30"));
        nvps.add(new BasicNameValuePair("servertime", String.valueOf(new Date().getTime())));
        nvps.add(new BasicNameValuePair("service", "sso"));
        nvps.add(new BasicNameValuePair("useticket", "0"));
        nvps.add(new BasicNameValuePair("vsnf", "1"));
        nvps.add(new BasicNameValuePair("su", encodeAccount(UserConstant.username)));//TODO
        nvps.add(new BasicNameValuePair("sp", getData(map)));//TODO
//        nvps.add(new BasicNameValuePair("sr", "rsa2"));//TODO
     ...
     * @return
     */
    public static Map<String , String> packageCookieHeaders(String cookie){
        Map<String , String> map = new HashMap<String, String>();
        map.put(HeaderConstant.Accept, "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8");
        map.put(HeaderConstant.Accept_Encoding, "gzip, deflate");
        map.put(HeaderConstant.Accept_Language, "zh-CN,zh;q=0.8,en-US;q=0.5,en;q=0.3");
        ...
        try {
            ...
            if (se instanceof Invocable) {
                ...
                pass = invoke.invokeFunction("getpass",
                        UserConstant.password, map.get("servertime"), map.get("nonce"),map.get("pubkey")).toString();
                logger.debug("encypt password : " + pass);
            }
    ...
    private static String encodeAccount(String account) {
        ...
        try {
            ...
            logger.debug("base64  userName : " + userName);
